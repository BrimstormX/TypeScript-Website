...
export function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: "2-day intensive training program + 1-week paid pilot to ensure your VA understands your process perfectly."
    },
    {
      number: "03",
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-24 left-1/2 transform -translate-x-1/2 w-full max-w-4xl">
            <div className="relative">
              ...
              <div className="absolute top-0 left-0 w-2/3 h-0.5 bg-va-gold"></div>
            </div>
          </div>
