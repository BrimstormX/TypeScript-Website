...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "First month + setup fee due upfront, then monthly billing thereafter. We require a 90-day minimum commitment. All plans include our non-solicit clause to protect both parties."
    },
    {
